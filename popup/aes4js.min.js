...
function aesEnc(key, salt, str) {
	...
	return derive(key,salt).then(function(key) {
...
function derive(plainText, salt) { // key derivation using 100k pbkdf w/sha256
